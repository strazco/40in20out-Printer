...
def hold():
  ...
  printer.print("please wait 30 seconds")
  printer.feed(1)
  printer.print("before unplugging")
  printer.feed(3)
  printer.print("this session presented by:")
  printer.feed(1)
  printer.printImage(Image.open('gfx/totemasset_logo.bmp'), True)
  printer.feed(3)
...
def main():
    ...
    printer.printImage(Image.open('gfx/40in20out_logo.bmp'), True)
    printer.feed(1)
